...
const description =
  "Type a Lens handle and watch its Circle of Affinity bloom — the accounts they mention, comment on and repost the most, over the last 90 days. No login, no wallet, no database.";
